...
namespace DivineInject.Test
{
    ...
    public class ClassGeneratorTest : AbstractNUnitMoqScenarioTest
    {
        ...
        public void GeneratesBasicClass()
        {
            ...
            Scenario()
                ...
                .When(instance = generator.Generate<IFactory, DomainObject>(
                    new List<InjectableConstructorArg>(), new List<ConstructorArg>(), injector))
        ...
        {
            ClassGenerator generator;
            InjectableConstructorArg property1, property2;
            dynamic instance;
            IDivineInjector injector;
            ...
            Scenario()
                .Given(injector = AMock<IDivineInjector>()
                    ...
                    .Instance)
                .Given(property1 = new InjectableConstructorArg(typeof(string), "Name"))
                .Given(property2 = new InjectableConstructorArg(typeof(int), "Age"))
